<template>
  <div class="page-grid ep approvals-page">
    ...
    <el-dialog v-model="detailVisible" title="审批详情" width="920px" destroy-on-close align-center>
