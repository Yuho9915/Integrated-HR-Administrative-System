...
DEFAULT_DATA = {
    'users': [
        ...
        {'id': 'user-manager', 'username': 'manager', 'password': '123456', 'name': '王嘉铭', 'role': 'manager', 'department': '市场部', 'employeeNo': 'MGR-0201', 'position': '部门经理'},
